...
import { reconnectSocketWithAuth } from "../../config/socket.config";
...
const LoginPage = () => {
  ...
  }, [isAuthenticated, navigate, user?.role?.name]);
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text type="secondary">Đăng nhập vào hệ thống quản lý nội bộ</Text>
        </Space>
        ...
        <Divider
          style={{ marginBlock: `${token.marginMD}px ${token.marginSM}px` }}
        />
        <Flex justify="center">
          <Space size={4}>
      ...
      >
        © {new Date().getFullYear()} F-Corp. Nền tảng quản lý nội bộ doanh
        nghiệp.
      </Text>
    </Flex>
  );
