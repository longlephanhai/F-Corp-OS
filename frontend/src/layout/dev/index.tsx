...
import { SprintInvitationSocketListener } from "../../components/dev/SprintInvitationSocketListener";
...
const DeveloperLayout = () => {
  ...
  return (
    <>
      <SprintInvitationSocketListener />
      <Layout>
        <SiderDev collapsed={collapsed} pathName={pathName} />
        <Layout>
          <HeaderLayout
